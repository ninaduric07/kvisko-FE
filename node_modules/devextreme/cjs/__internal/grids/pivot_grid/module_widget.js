...
var PivotGrid = ui_widget_1.default.inherit({
    ...
    _initDataController: function() {
        ...
        that._dataController = new module_1.default.DataController(that._getDataControllerOptions());
    ...
    _optionChanged: function(args) {
        ...
        switch (args.name) {
            ...
            case "rtlEnabled":
                ...
                window_1.hasWindow() && this._renderLoadPanel(this._dataArea.groupElement(), this.$element());
                this._invalidate();
                break;
            case "export":
    ...
    _renderFieldChooser: function() {
        ...
        if (that._fieldChooserPopup) {
            ...
            that._fieldChooserPopup = that._createComponent(renderer_1.default(DIV).addClass(FIELD_CHOOSER_POPUP_CLASS).appendTo(container), ui_popup_1.default, popupOptions)
        }
    },
    ...
    _getContextMenuItems: function(e) {
        ...
        if ("row" === e.area || "column" === e.area) {
            ...
            var oppositeAreaFields_1 = e["column" === e.area ? "rowFields" : "columnFields"];
            ...
            if (e.cell.isLast && !dataSource_1.paginate()) {
                ...
                iterator_1.each(oppositeAreaFields_1, (function(_, field) {
                    ...
                    iterator_1.each(e.dataFields, (function(dataIndex, dataField) {
                        ...
                        items.push({
                            beginGroup: 0 === sortingBySummaryItemCount_1,
    ...
    _createEventArgs: function(targetElement, dxEvent) {
        ...
        if (clickedOnFieldsArea(renderer_1.default(targetElement))) {
            return extend_1.extend(this._createFieldArgs(targetElement), args)
        }
        return extend_1.extend(this._createCellArgs(targetElement), args)
    },
    ...
    _renderDescriptionArea: function() {
        ...
        if (this.option("fieldChooser.enabled")) {
            var $buttonElement = renderer_1.default(DIV).appendTo($toolbarContainer).addClass("dx-pivotgrid-field-chooser-button");
            var buttonOptions = {
                icon: "columnchooser",
        ...
        if (this.option("export.enabled")) {
            $buttonElement = renderer_1.default(DIV).appendTo($toolbarContainer).addClass("dx-pivotgrid-export-button");
            buttonOptions = {
                icon: "xlsxfile",
    ...
    _detectHasContainerHeight: function() {
        ...
        this._hasHeight = size_1.getHeight(element) !== TEST_HEIGHT;
    ...
    _renderHeaders: function(rowHeaderContainer, columnHeaderContainer, filterHeaderContainer, dataHeaderContainer) {
        var dataSource = this.getDataSource();
        this._rowFields = this._rowFields || new module_4.FieldsArea(this, "row");
        this._rowFields.render(rowHeaderContainer, dataSource.getAreaFields("row"));
        this._columnFields = this._columnFields || new module_4.FieldsArea(this, "column");
        this._columnFields.render(columnHeaderContainer, dataSource.getAreaFields("column"));
        this._filterFields = this._filterFields || new module_4.FieldsArea(this, "filter");
        this._filterFields.render(filterHeaderContainer, dataSource.getAreaFields("filter"));
        this._dataFields = this._dataFields || new module_4.FieldsArea(this, "data");
    ...
    _createTableElement: function() {
        var $table = renderer_1.default("<table>").css({
            width: "100%"
        }).toggleClass(BORDERS_CLASS, !!this.option("showBorders")).toggleClass("dx-word-wrap", !!this.option("wordWrapEnabled"));
        events_engine_1.default.on($table, index_1.addNamespace(click_1.name, "dxPivotGrid"), "td", this._handleCellClick.bind(this));
        return $table
    },
    _renderDataArea: function(dataAreaElement) {
        var dataArea = this._dataArea || new module_2.default.DataArea(this);
    ...
    _renderRowsArea: function(rowsAreaElement) {
        var rowsArea = this._rowsArea || new module_3.default.VerticalHeadersArea(this);
    ...
    _renderColumnsArea: function(columnsAreaElement) {
        var columnsArea = this._columnsArea || new module_3.default.HorizontalHeadersArea(this);
    ...
    _renderContentImpl: function() {
        ...
        if (!tableElement) {
            ...
            this._pivotGridContainer = renderer_1.default(DIV).addClass("dx-pivotgrid-container");
            this._renderFieldChooser();
            this._renderContextMenu();
            ...
            renderer_1.default(TR).append(filterHeaderContainer).appendTo(tableElement);
            renderer_1.default(TR).append(dataHeaderContainer).append(columnHeaderContainer).appendTo(tableElement);
            renderer_1.default(TR).append(rowHeaderContainer).append(columnsAreaElement).appendTo(tableElement);
            renderer_1.default(TR).addClass(BOTTOM_ROW_CLASS).append(rowsAreaElement).append(dataAreaElement).appendTo(tableElement);
        ...
        this._createComponent(this.$element(), module_base_1.FieldChooserBase, {
    ...
    updateDimensions: function() {
        ...
        common_1.deferUpdate((function() {
            ...
            var descriptionCellHeight = size_1.getOuterHeight(descriptionCell[0], true) + (needSynchronizeFieldPanel ? rowHeights[0] : 0);
            ...
            if (that._hasHeight) {
                ...
                dataAreaHeight = size_1.getHeight(that.$element()) - filterAreaHeight - dataHeaderHeight - (Math.max(size_1.getHeight(that._dataArea.headElement()), size_1.getHeight(columnAreaCell), descriptionCellHeight) + bordersWidth)
            }
            ...
            common_1.deferRender((function() {
                ...
                if (that._hasHeight && that._filterFields.isVisible() && size_1.getHeight(filterHeaderCell) !== filterAreaHeight) {
...
}).inherit(module_6.ExportController).include(module_7.ChartIntegrationMixin);
