...
exports.getRealElementWidth = exports.AreaItem = void 0;
...
var getMemoizeScrollTo_1 = require("../../../../renovation/ui/common/utils/scroll/getMemoizeScrollTo");
var PIVOTGRID_EXPAND_CLASS = "dx-expand";
var getRealElementWidth = function(element) {
    var width = 0;
    var offsetWidth = element.offsetWidth;
    if (element.getBoundingClientRect) {
        var clientRect = position_1.getBoundingRect(element);
...
var AreaItem = class_1.default.inherit({
    ...
    _createTableElement: function() {
        return renderer_1.default("<table>")
    },
    _getCellText: function(cell, encodeHtml) {
        ...
        if (encodeHtml && (-1 !== cellText.indexOf("<") || -1 !== cellText.indexOf(">"))) {
            cellText = renderer_1.default("<div>").text(cellText).html()
        }
        return cellText
    },
    ...
    _renderTableContent: function(tableElement, data) {
        ...
        for (i = 0; i < rowsCount; i += 1) {
            ...
            for (j = 0; j < row.length; j += 1) {
                ...
                if (type_1.isDefined(cell.wordWrapEnabled)) {
            ...
            for (rowIndex = 0; rowIndex < data.length; rowIndex += 1) {
                ...
                for (columnIndex = 0; columnIndex < row.length; columnIndex += 1) {
                    ...
                    if (hasEvent) {
                        ...
                        onCellPrepared(extend_1.extend(onCellPreparedArgs, defaultActionArgs))
                    }
                }
            }
        }
    ...
    _getRowHeight: function(index) {
        ...
        if (row && row.lastChild) {
            if (row.getBoundingClientRect) {
                var clientRect = position_1.getBoundingRect(row);
    ...
    resetColumnsWidth: function() {
        size_1.setWidth(this._colgroupElement.find("col"), "auto");
    ...
    _renderVirtualContent: function() {
        if (!this._virtualContent && "virtual" === this.option("scrolling.mode")) {
            this._virtualContent = renderer_1.default("<div>").addClass("dx-virtual-content").insertBefore(this._tableElement)
        }
    },
    reset: function() {
        var tableElement = this._tableElement[0];
    ...
    render: function(rootElement, data) {
        ...
        this._colgroupElement = renderer_1.default("<colgroup>").appendTo(this._tableElement);
    ...
    _getMemoizeScrollTo: function() {
        var _this = this;
        var _a;
        this._memoizeScrollTo = null !== (_a = this._memoizeScrollTo) && void 0 !== _a ? _a : getMemoizeScrollTo_1.getMemoizeScrollTo((function() {
            return _this._getScrollable()
        }));
        return this._memoizeScrollTo
    },
    _getMaxLeftOffset: function(scrollable) {
        var containerElement = renderer_1.default(scrollable.container()).get(0);
    ...
    on: function(eventName, handler) {
        ...
        if (scrollable) {
            scrollable.on(eventName, (function(e) {
                if (that.option("rtlEnabled") && type_1.isDefined(e.scrollOffset.left)) {
    ...
    scrollTo: function(pos, force) {
        ...
        var rtlEnabled = this.option("rtlEnabled");
        var areaName = this._getAreaName();
        var scrollablePos = __assign(__assign({}, pos), {
