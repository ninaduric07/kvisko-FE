...
function createForeachTreeFunc(isAsync) {
    var foreachTreeFunc = function(items, callback, parentAtFirst, members, index, isChildrenProcessing) {
        ...
        function createForeachTreeAsyncHandler(deferred, i, isChildrenProcessing) {
            deferred_1.when(foreachTreeFunc(items, callback, parentAtFirst, members, i, isChildrenProcessing)).done(deferred.resolve)
        }
...
function createGroupFields(item) {
    return iterator_1.map(["year", "quarter", "month"], (function(value, index) {
        return extend_1.extend({}, item, {
            groupInterval: value,
            groupIndex: index
        })
    }))
...
var DATE_INTERVAL_FORMATS = {
    ...
    quarter: function(value) {
        return date_1.default.format(new Date(2e3, 3 * value - 1), "quarter")
    },
...
function setDefaultFieldValueFormatting(field) {
    if ("date" === field.dataType) {
        ...
        var groupInterval_1 = type_1.isNumeric(field.groupInterval) && field.groupInterval > 0 && field.groupInterval;
