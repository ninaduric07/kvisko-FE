...
var ValidatingController = modules_1.default.Controller.inherit({
    init: function() {
    ...
    _getValidationData: function(key, create) {
        ...
        if (isObjectKeyHash) {
            validationData = this._validationState.filter((function(data) {
                return common_1.equalByValue(data.key, key)
            }))[0]
        } else {
    ...
    validateGroup: function(validationData) {
        ...
        deferred_1.when((null === validationResult || void 0 === validationResult ? void 0 : validationResult.complete) || validationResult).done((function(validationResult) {
    ...
    renderCellPendingIndicator: function($container) {
        ...
        if (!$indicator.length) {
            ...
            $indicator = renderer_1.default("<div>").appendTo($indicatorContainer).addClass(PENDING_INDICATOR_CLASS);
    ...
    createValidator: function(parameters, $container) {
        ...
        if (needCreateValidator) {
            ...
            var getValue = function() {
                var change = editingController.getChangeByKey(null === validationData_2 || void 0 === validationData_2 ? void 0 : validationData_2.key);
            ...
            var validator = new validator_1.default($container || renderer_1.default("<div>"), {
                ...
                dataGetter: function() {
                    var key = null === validationData_2 || void 0 === validationData_2 ? void 0 : validationData_2.key;
                    var change = editingController.getChangeByKey(key);
                    var oldData = editingController._getOldData(key);
                    return {
                        data: array_utils_1.createObjectWithChanges(oldData, null === change || void 0 === change ? void 0 : change.data),
                        column: column
                    }
                },
            ...
            if (useDefaultValidator) {
                ...
                if (adapter_1) {
                    ...
                    adapter_1.bypass = function() {
                        return originBypass_1.call(adapter_1) || parameters.row.isNewRow && !_this._isValidationInProgress && !editingController.isCellModified(parameters)
                    }
                }
            }
            return validator
    ...
    isCurrentValidatorProcessing: function(_a) {
        ...
        return this._currentCellValidator && common_1.equalByValue(this._currentCellValidator.option("validationGroup").key, rowKey) && this._currentCellValidator.option("dataGetter")().column.index === columnIndex
    },
    ...
    getCellValidationResult: function(_a) {
        ...
        return null === (_b = null === validationData || void 0 === validationData ? void 0 : validationData.validationResults) || void 0 === _b ? void 0 : _b[columnIndex]
    },
        ...
        controllers: {
            editing: {
                ...
                processItems: function(items, changeType) {
                    ...
                    if (this.getEditMode() === EDIT_MODE_BATCH && "prepend" !== changeType && "append" !== changeType) {
                        changes.forEach((function(change) {
                            ...
                            if (validationData && change.type && validationData.pageIndex === _this._pageIndex && (null === change || void 0 === change ? void 0 : change.pageIndex) !== _this._pageIndex) {
                        ...
                        iterator_1.each(columns, (function(_, column) {
                            changes.forEach((function(change) {
                                ...
                                if (function(column, rowKey) {
                                        return _this._dataController.getRowIndexByKey(rowKey) >= 0 && invisibleColumns.indexOf(column) < 0
                                    }(column, change.key)) {
                                    return
                                }
                                if (change.type === EDIT_DATA_INSERT_TYPE) {
                ...
                updateFieldValue: function(e) {
                    ...
                    this.callBase.apply(this, arguments).done((function() {
                        ...
                        deferred_1.when(currentValidator && validatingController.validateCell(currentValidator)).done((function(validationResult) {
            ...
            editorFactory: {
                _showRevertButton: function($container) {
                    ...
                    null === $tooltipElement || void 0 === $tooltipElement ? void 0 : $tooltipElement.remove();
                    $tooltipElement = renderer_1.default("<div>").addClass(revertTooltipClass).appendTo($container);
                    var tooltipOptions = {
                        animation: null,
                        visible: true,
                        width: "auto",
                ...
                _showValidationMessage: function($cell, messages, alignment) {
                    ...
                    var $overlayElement = renderer_1.default("<div>").addClass(INVALID_MESSAGE_CLASS).addClass(INVALID_MESSAGE_ALWAYS_CLASS).addClass(invalidMessageClass).html(errorMessageText).appendTo($cell);
                    var overlayOptions = {
                        container: $overlayContainer,
                        shading: false,
                        width: "auto",
                ...
                _normalizeValidationMessagePositionAndMaxWidth: function(options, isRevertButton, isOverlayVisible) {
                    ...
                    var position;
                    var visibleTableWidth = !isRevertButton && (that = this, element = options.element, rowIndex = renderer_1.default(element).closest("tr").index(), $cellElements = renderer_1.default(that._rowsView.getRowElement(rowIndex)).first().children().filter(":not(.dx-hidden-cell)"), that._rowsView._getWidths($cellElements).reduce((function(w1, w2) {
                        return w1 + w2
                    }), 0));
            ...
            data: {
                ...
                _isCellChanged: function(oldRow, newRow, visibleRowIndex, columnIndex, isLiveUpdate) {
                    ...
                    var cellIsMarkedAsInvalid = renderer_1.default(null === cell || void 0 === cell ? void 0 : cell.cellElement).hasClass(this.addWidgetPrefix(INVALIDATE_CLASS));
            ...
            rowsView: {
                updateFreeSpaceRowHeight: function($table) {
                    ...
                    if ($tooltipContent && $tooltipContent.length) {
                        ...
                        if ($freeSpaceRowElement && 1 === $rowElements.length && (!$freeSpaceRowElement.is(":visible") || size_1.getOuterHeight($tooltipContent) > size_1.getOuterHeight($freeSpaceRowElement))) {
