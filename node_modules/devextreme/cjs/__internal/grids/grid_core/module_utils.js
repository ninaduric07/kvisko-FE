...
var equalFilterParameters = function(filter1, filter2) {
    ...
    if (type_1.isFunction(filter1) && filter1.columnIndex >= 0 && type_1.isFunction(filter2) && filter2.columnIndex >= 0) {
        return filter1.columnIndex === filter2.columnIndex && data_1.toComparable(filter1.filterValue) === data_1.toComparable(filter2.filterValue) && data_1.toComparable(filter1.selectedFilterOperation) === data_1.toComparable(filter2.selectedFilterOperation)
    }
    return data_1.toComparable(filter1) == data_1.toComparable(filter2)
};
...
exports.default = {
    renderNoDataText: function($element) {
        ...
        if (!noDataElement.length) {
            noDataElement = renderer_1.default("<span>").addClass(noDataClass).appendTo($element)
        }
    ...
    renderLoadPanel: function($element, $container, isLocalStore) {
        ...
        if (loadPanelOptions && ("auto" === loadPanelOptions.enabled ? !isLocalStore : loadPanelOptions.enabled)) {
            ...
            this._loadPanel = this._createComponent(renderer_1.default("<div>").appendTo($container), load_panel_1.default, loadPanelOptions)
        } else {
        ...
        return {
            ...
            render: function(container, options) {
                ...
                if (type_1.isDefined(options.value) && !(options.data && options.data.isContinuation) && !options.row.isNewRow) {
                    ...
                    renderer_1.default("<div>").addClass(options.value ? DATAGRID_GROUP_OPENED_CLASS : DATAGRID_GROUP_CLOSED_CLASS).appendTo($container);
    ...
    getContentHeightLimit: function(browser) {
        ...
        return 15e6 / this.getPixelRatio(window_1.getWindow())
    },
    ...
    getWrappedLookupDataSource: function(column, dataSource, filter) {
        ...
        var lookupDataSource = __assign(__assign({}, lookupDataSourceOptions), {
            ...
            load: function(loadOptions) {
                ...
                (function(loadOptions) {
                    ...
                    var newDataSource = new data_source_1.DataSource(__assign(__assign(__assign({}, lookupDataSourceOptions), loadOptions), {
