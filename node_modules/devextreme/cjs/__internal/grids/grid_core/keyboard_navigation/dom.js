...
var isDragCell = function($cell) {
    return void 0 !== $cell.attr(const_1.ATTRIBUTES.dragCell)
};
var getCellToFocus = function($cellElements, columnIndex) {
    return $cellElements.filter("[" + const_1.ATTRIBUTES.ariaColIndex + '="' + (columnIndex + 1) + '"]:not([' + const_1.ATTRIBUTES.dragCell + "])").first()
};
