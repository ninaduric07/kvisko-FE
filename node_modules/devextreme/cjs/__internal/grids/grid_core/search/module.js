                        ...
                        for (i = 0; i < columns.length; i++) {
                            ...
                            if (allowSearch(column) && column.calculateFilterExpression) {
                                ...
                                if (lookup && lookup.items) {
                                    query_1.default(lookup.items).filter(column.createFilterExpression.call({
        ...
        views: {
                        ...
                        if (searchPanelOptions && searchPanelOptions.visible) {
                            var toolbarItem = {
                                template: function(data, index, container) {
                                    var $search = renderer_1.default("<div>").addClass(that.addWidgetPrefix(SEARCH_PANEL_CLASS)).appendTo(container);
            ...
            rowsView: {
                ...
                _highlightSearchTextCore: function($textNode, searchText) {
                    var $searchTextSpan = renderer_1.default("<span>").addClass(this.addWidgetPrefix(SEARCH_TEXT_CLASS));
