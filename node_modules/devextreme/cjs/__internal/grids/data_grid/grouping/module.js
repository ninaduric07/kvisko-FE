...
var GroupingDataControllerExtender = {
    ...
    _processItem: function(item, options) {
        if (type_1.isDefined(item.groupIndex) && type_1.isString(item.rowType) && 0 === item.rowType.indexOf("group")) {
...
exports.GroupingHeaderPanelExtender = {
        ...
        if (this._isGroupPanelVisible()) {
            ...
            var toolbarItem = {
                template: function() {
                    ...
                    ui_grid_core_accessibility_1.registerKeyboardAction("groupPanel", _this, $groupPanel, void 0, _this._handleActionKeyDown.bind(_this));
                    return $groupPanel
                },
                name: "groupPanel",
    ...
    _isGroupPanelVisible: function() {
        ...
        if (groupPanelOptions) {
            ...
            if ("auto" === isVisible) {
                isVisible = "desktop" === devices_1.default.current().deviceType
            }
        }
        return isVisible
    },
    ...
    _createGroupPanelItem: function($rootElement, groupColumn) {
        var $groupPanelItem = renderer_1.default("<div>").addClass(groupColumn.cssClass).addClass(DATAGRID_GROUP_PANEL_ITEM_CLASS).data("columnData", groupColumn).appendTo($rootElement).text(groupColumn.caption);
    ...
    _updateGroupPanelContent: function($groupPanel) {
        ...
        if (groupPanelOptions.allowColumnDragging && !groupColumns.length) {
            renderer_1.default("<div>").addClass(DATAGRID_GROUP_PANEL_MESSAGE_CLASS).text(groupPanelOptions.emptyPanelText).appendTo($groupPanel);
...
var GroupingRowsViewExtender = {
    ...
    _rowClick: function(e) {
        ...
        var scrollingMode = this.option("scrolling.mode");
        var isGroupRowStateChanged = "infinite" !== scrollingMode && "rowClick" === expandMode && renderer_1.default(e.event.target).closest("." + DATAGRID_GROUP_ROW_CLASS).length;
        ...
        controllers: {
            ...
            editing: {
                _isProcessedItem: function(item) {
                    return type_1.isDefined(item.groupIndex) && type_1.isString(item.rowType) && 0 === item.rowType.indexOf("group")
                }
            }
        },
        views: {
