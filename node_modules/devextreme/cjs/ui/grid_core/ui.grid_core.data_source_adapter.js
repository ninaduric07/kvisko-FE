...
var _default = _uiGrid_core.default.Controller.inherit(function() {
    ...
    function calculateOperationTypes(loadOptions, lastLoadOptions, isFullReload) {
        ...
        if (lastLoadOptions) {
            operationTypes = {
                sorting: !_uiGrid_core2.default.equalSortParameters(loadOptions.sort, lastLoadOptions.sort),
                grouping: !_uiGrid_core2.default.equalSortParameters(loadOptions.group, lastLoadOptions.group, true),
                groupExpanding: !_uiGrid_core2.default.equalSortParameters(loadOptions.group, lastLoadOptions.group) || lastLoadOptions.groupExpand,
                filtering: !_uiGrid_core2.default.equalFilterParameters(loadOptions.filter, lastLoadOptions.filter),
    ...
    function getPageDataFromCache(options, updatePaging) {
        var groupCount = _uiGrid_core2.default.normalizeSortingInfo(options.group || options.storeLoadOptions.group || options.loadOptions.group).length;
        var items = [];
    ...
    var members = {
        ...
        _applyBatch: function(changes, fromStore) {
            ...
            var dataSource = this._dataSource;
            var groupCount = _uiGrid_core2.default.normalizeSortingInfo(this.group()).length;
        ...
        _handleDataLoaded: function(options) {
            ...
            var groupCount = _uiGrid_core2.default.normalizeSortingInfo(options.group || storeLoadOptions.group || loadOptions.group).length;
            ...
            if (!needPageCache || !getPageDataFromCache(options)) {
                ...
                if (needPagingCache && options.cachedPagingData) {
                    ...
                    if (needStoreCache) {
                        if (!this._cachedStoreData) {
                            this._cachedStoreData = cloneItems(options.data, _uiGrid_core2.default.normalizeSortingInfo(storeLoadOptions.group).length)
