...
var FileManagerThumbnailsItemList = function(_FileManagerItemListB) {
    ...
    _proto._onItemListContentReady = function() {
    ...
    _proto._resetScrollTopPosition = function() {
        ...
        setTimeout((function() {
            ...
            return null === (_this$_itemList$getSc = _this._itemList.getScrollable()) || void 0 === _this$_itemList$getSc ? void 0 : _this$_itemList$getSc.scrollTo(0)
        }))
    };
