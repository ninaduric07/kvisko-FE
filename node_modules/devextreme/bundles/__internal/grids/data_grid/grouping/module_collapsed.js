/**
 * DevExtreme (bundles/__internal/grids/data_grid/grouping/module_collapsed.js)
 * Version: 22.2.6
    ...
    function loadGroupItems(that, options, loadedGroupCount, expandedInfo, groupLevel, data) {
        ...
        if (expandedInfo.paths.length && groupCount - loadedGroupCount > 0) {
            ...
            ! function(that, options, expandedInfo, data) {
                ...
                deferred_1.when(0 === expandedInfo.take ? [] : that._dataSource.loadFromStore(loadOptions)).done((function(items) {
                    if (isPagingLocal) {
    ...
    return {
        ...
        handleDataLoading: function(options) {
            ...
            if (options.remoteOperations.grouping) {
                var remotePaging_1 = this._dataSource.remoteOperations().paging;
