...
var renderSummaryCell = function(cell, options) {
    ...
    if (!column.command && summaryItems) {
        for (var i = 0; i < summaryItems.length; i++) {
            ...
            $summaryItems.push(renderer_1.default("<div>").css("textAlign", summaryItem.alignment || column.alignment).addClass(DATAGRID_SUMMARY_ITEM_CLASS).addClass(DATAGRID_TEXT_CONTENT_CLASS).addClass(summaryItem.cssClass).toggleClass(DATAGRID_GROUP_TEXT_CONTENT_CLASS, "group" === options.rowType).text(module_core_1.default.getSummaryText(summaryItem, options.summaryTexts)))
        }
...
exports.FooterView = ui_grid_core_columns_view_1.ColumnsView.inherit({
    _getRows: function() {
    ...
    var applyRemovedData = function(data, removedData, groupLevel) {
        if (groupLevel) {
            return data.map((function(data) {
                ...
                return extend_1.extend(updatedData, data, {
                    items: updatedItems
                })
            }))
        }
        ...
        _handleDataLoadedCore: function(options) {
            ...
            if (!options.isCustomLoading || options.storeLoadOptions.isLoadingAll) {
                if (remoteOperations.summary) {
                    ...
                    var hasOperations = Object.keys(operationTypes_1).some((function(type) {
                        return operationTypes_1[type]
                    }));
            ...
            data: {
                ...
                _prepareUnsavedDataSelector: function(selector) {
                    if (recalculateWhileEditing(this)) {
                        var editingController_1 = this.getController("editing");
            ...
            rowsView: {
                ...
                _renderGroupSummaryCellsCore: function($groupCell, options, groupCellColSpan, alignByColumnCellCount) {
                    if (alignByColumnCellCount > 0) {
                        ...
                        for (var i = 0; i < alignByColumnCellCount; i++) {
                            ...
                            this._renderCell($groupCell.parent(), extend_1.extend({
                ...
                _getCellOptions: function(options) {
                    ...
                    if (options.row.summaryCells) {
                        return extend_1.extend(parameters, getSummaryCellOptions(this, options))
                    }
                    return parameters
                }
            }
