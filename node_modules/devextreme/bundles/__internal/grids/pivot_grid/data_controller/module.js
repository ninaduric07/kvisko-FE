            ...
            deferred_1.when(viewHeaderItems).done((function(viewHeaderItems) {
                    ...
                    ! function(headerItems, headerDescriptions, showTotalsPrior, isTree) {
                        ...
                        module_widget_utils_1.foreachTree(headerItems, (function(items, index) {
                            ...
                            if (item.type === DATA_TYPE && item.expanded && (false !== dataField.showTotals || isTree)) {
                                -1 !== index && parentChildren.splice(showTotalsPrior ? index : index + 1, 0, extend_1.extend({}, item, {
                                    children: null,
                                    type: TOTAL_TYPE,
                ...
                deferred_1.when(module_widget_utils_1.foreachTreeAsync(viewHeaderItems, (function(items) {
                    ...
                    if (cellDescriptionsCount > 1) {
                        ...
                        module_widget_utils_1.foreachTree([{
                            ...
                            iterator_1.each(options.sortBySummaryPaths, (function(_, sortBySummaryPath) {
                                ...
                                if (function(items, sortBySummaryPath) {
                                        ...
                                        if (stringValuesUsed && -1 !== sortBySummaryPath[0].indexOf("&[") && headerItem.key || !headerItem.key) {
                                            ...
                                            path = iterator_1.map(items, (function(item) {
    ...
    var members = {
            ...
            for (var i = 0; i < expandedPaths.length; i += 1) {
                if (expandedTakes[i]) {
                    ...
                    storeLoadOptions.push(extend_1.extend({
                        area: area,
                        headerName: area + "s"
                    }, options, (_a = {}, _a[area + "Skip"] = expandedSkips[i], _a[area + "Take"] = expandedTakes[i], _a[isOppositeArea ? "oppositePath" : "path"] = expandedPaths[i], _a)))
                }
            }
        },
        ...
        getRowsInfo: function(getAllData) {
            ...
            if (scrollController && !getAllData) {
                var startIndex_1 = scrollController.beginPageIndex() * this.rowPageSize();
                var endIndex_1 = scrollController.endPageIndex() * this.rowPageSize() + this.rowPageSize();
                var newRowsInfo_1 = [];
                var maxDepth_1 = 1;
                foreachRowInfo(rowsInfo, (function(rowInfo, visibleIndex, rowIndex, _, columnIndex) {
                    ...
                    if (isVisible) {
                        ...
                        rowspan = rowIndex < startIndex_1 ? rowInfo.rowspan - (startIndex_1 - rowIndex) || 1 : rowInfo.rowspan;
                ...
                foreachRowInfo(newRowsInfo_1, (function(rowInfo, visibleIndex, rowIndex, columnIndex, realColumnIndex) {
