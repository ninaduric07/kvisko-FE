/**
 * DevExtreme (bundles/__internal/grids/grid_core/adaptivity/module.js)
 * Version: 22.2.6
...
var adaptiveColumnsControllerMembers = {
    ...
    _hideVisibleColumn: function(_a) {
        var isCommandColumn = _a.isCommandColumn,
            visibleIndex = _a.visibleIndex;
        var that = this;
    ...
    hideRedundantColumns: function(resultWidths, visibleColumns, hiddenQueue) {
        ...
        if (this._isVisibleColumnsValid(visibleColumns) && hiddenQueue.length) {
            ...
            var rootElementWidth = size_1.getWidth($rootElement) - this._getCommandColumnsWidth();
    ...
    createFormByHiddenColumns: function(container, options) {
        ...
        var defaultFormOptions = themes_1.isMaterial() ? {
            colCount: 2
        } : {};
    ...
    updateHidingQueue: function(columns) {
        var hideableColumns = columns.filter((function(column) {
            return column.visible && !column.type && !column.fixed && !(type_1.isDefined(column.groupIndex) && column.groupIndex >= 0)
        }));
        ...
        controllers: {
            ...
            data: {
                _processItems: function(items, change) {
                    ...
                    if ("loadingAll" === changeType || !type_1.isDefined(this._adaptiveExpandedKey)) {
                        return items
                    }
                ...
                toggleExpandAdaptiveDetailRow: function(key, alwaysExpanded) {
                    var oldExpandLoadedRowIndex = module_utils_1.default.getIndexByKey(this._adaptiveExpandedKey, this._items);
                    var newExpandLoadedRowIndex = module_utils_1.default.getIndexByKey(key, this._items);
            ...
            keyboardNavigation: {
                ...
                _processNextCellInMasterDetail: function($nextCell, $cell) {
                    ...
                    if (isEditing && $nextCell && isCellOrBatchMode && !this._isInsideEditForm($nextCell)) {
                        events_engine_1.default.off($nextCell, "focus", focusCellHandler);
                        events_engine_1.default.on($nextCell, "focus", {
                            $nextCell: $nextCell
                        }, focusCellHandler);
