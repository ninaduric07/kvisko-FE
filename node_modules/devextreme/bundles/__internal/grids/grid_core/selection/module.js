/**
 * DevExtreme (bundles/__internal/grids/grid_core/selection/module.js)
 * Version: 22.2.6
...
var SelectionController = modules_1.default.Controller.inherit(function() {
    ...
    return {
        init: function() {
            var _a = this.option("selection") || {},
                deferred = _a.deferred,
                selectAllMode = _a.selectAllMode,
                mode = _a.mode;
        ...
        _handleDataPushed: function(changes) {
            ...
            if (this.option("selection.deferred")) {
                var selectedKeys_1 = this._dataController.items().filter((function(item) {
                    return item.isSelected
                })).map((function(item) {
                    return item.key
                }));
                removedKeys = removedKeys.filter((function(key) {
                    return selectedKeys_1.find((function(selectedKey) {
                        return common_1.equalByValue(selectedKey, key)
                    }))
                }))
            }
        ...
        _getSelectionConfig: function() {
            ...
            return {
                ...
                load: function(options) {
                    var _a;
                    return (null === (_a = dataController.dataSource()) || void 0 === _a ? void 0 : _a.load(options)) || (new deferred_1.Deferred).resolve([])
                },
                plainItems: function() {
                ...
                getItemData: function(item) {
                    return type_1.isDefined(null === item || void 0 === item ? void 0 : item.rowType) ? (null === item || void 0 === item ? void 0 : item.oldData) || (null === item || void 0 === item ? void 0 : item.data) : item
                },
                filter: function() {
                ...
                getLoadOptions: function(loadItemIndex, focusedItemIndex, shiftItemIndex) {
                    var _a, _b;
                    var _c = null !== (_b = null === (_a = dataController.dataSource()) || void 0 === _a ? void 0 : _a.lastLoadOptions()) && void 0 !== _b ? _b : {},
                        sort = _c.sort,
                        filter = _c.filter;
        ...
        views: {
            columnHeadersView: {
                ...
                _renderSelectAllCheckBox: function($container, column) {
                    ...
                    var groupElement = renderer_1.default("<div>").appendTo($container).addClass(SELECT_CHECKBOX_CLASS);
            ...
            rowsView: {
                ...
                _renderSelectCheckBox: function(container, options) {
                    var groupElement = renderer_1.default("<div>").addClass(SELECT_CHECKBOX_CLASS).appendTo(container);
                ...
                _createTable: function() {
                    ...
                    if ("none" !== selectionMode) {
                        if ("onLongTap" === that.option(SHOW_CHECKBOXES_MODE) || !support_1.touch) {
                ...
                _rowClick: function(e) {
                    ...
                    if (!this.isClickableElement(renderer_1.default(dxEvent.target))) {
