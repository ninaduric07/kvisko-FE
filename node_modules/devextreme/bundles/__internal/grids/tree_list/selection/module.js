...
var originalRowClick = ui_grid_core_selection_1.selectionModule.extenders.views.rowsView._rowClick;
var originalHandleDataChanged = ui_grid_core_selection_1.selectionModule.extenders.controllers.data._handleDataChanged;
var nodeExists = function(array, currentKey) {
    return !!array.filter((function(key) {
        return key === currentKey
    })).length
};
module_core_1.default.registerModule("selection", extend_1.extend(true, {}, ui_grid_core_selection_1.selectionModule, {
    defaultOptions: function() {
        return extend_1.extend(true, ui_grid_core_selection_1.selectionModule.defaultOptions(), {
            selection: {
            ...
            selection: {
                ...
                _getSelectionConfig: function() {
                    ...
                    config.plainItems = function(cached) {
                        ...
                        result || (result = plainItems.apply(_this, arguments).map((function(item) {
                            return item.data
                        })));
                        return result || []
                    };
                ...
                _updateSelectColumn: common_1.noop,
                _getSelectAllNodeKeys: function() {
                    ...
                    root && module_core_1.default.foreachNodes(root.children, (function(node) {
                ...
                selectedItemKeys: function(value, preserve, isDeselect, isSelectAll) {
                    ...
                    var normalizedArgs = isRecursiveSelection && that._normalizeSelectionArgs({
                        keys: type_1.isDefined(value) ? value : []
                    }, preserve, !isDeselect);
                    if (normalizedArgs && !common_1.equalByValue(normalizedArgs.selectedRowKeys, selectedRowKeys)) {
                ...
                changeItemSelection: function(itemIndex, keyboardKeys) {
                    ...
                    if (isRecursiveSelection && !keyboardKeys.shift) {
                        var key_1 = this._dataController.getKeyByRowIndex(itemIndex);
                        return this.selectedItemKeys(key_1, true, this.isRowSelected(key_1)).done((function() {
                            _this.isRowSelected(key_1) && _this.callBase(itemIndex, keyboardKeys, true)
                        }))
                    }
                ...
                _getSelectedChildKeys: function(key, keysToIgnore) {
                    ...
                    node && module_core_1.default.foreachNodes(node.children, (function(childNode) {
                        ...
                        return ignoreKeyIndex > 0 || ignoreKeyIndex < 0 && void 0 === _this._selectionStateByKey[childNode.key]
                    }));
                    return childKeys
                },
                ...
                _normalizeChildrenKeys: function(key, args) {
                    ...
                    node && node.children.forEach((function(childNode) {
                        ...
                        _this._normalizeChildrenKeys(childNode.key, args)
                    }))
                },
                ...
                _getAllSelectedRowKeys: function(keys) {
                    ...
                    var result = [];
                    keys.forEach((function(key) {
                        var parentKeys = _this._getSelectedParentKeys(key, [], true);
                        var childKeys = _this._getAllChildKeys(key);
