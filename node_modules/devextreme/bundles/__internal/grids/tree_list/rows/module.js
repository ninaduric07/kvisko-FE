/**
 * DevExtreme (bundles/__internal/grids/tree_list/rows/module.js)
 * Version: 22.2.6
...
exports.RowsView = ui_grid_core_rows_1.rowsModule.views.rowsView.inherit(function() {
    var createIcon = function(hasIcon, isExpanded) {
        var $iconElement = renderer_1.default("<div>").addClass(TREELIST_EMPTY_SPACE);
        if (hasIcon) {
            $iconElement.toggleClass(TREELIST_EXPANDED_CLASS, isExpanded).toggleClass(TREELIST_COLLAPSED_CLASS, !isExpanded).append(renderer_1.default("<span>"))
        }
        return $iconElement
    };
    return {
        _renderIconContainer: function($container, options) {
            var _this = this;
            var $iconContainer = renderer_1.default("<div>").addClass(TREELIST_EXPAND_ICON_CONTAINER_CLASS).appendTo($container);
                    ...
                    render: function(options) {
                        ...
                        if (that._renderCellCommandContent($container, options.model)) {
                            options.container = function($container) {
                                return renderer_1.default("<div>").addClass(TREELIST_TEXT_CONTENT).appendTo($container)
                            }($container)
                        }
...
module_core_1.default.registerModule("rows", {
    defaultOptions: ui_grid_core_rows_1.rowsModule.defaultOptions,
    views: {
